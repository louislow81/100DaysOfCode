...
const logoHeader = () => 
  craft("img", {
    props: {
      class: "inline-block padding-y-8 height-40 width-auto object-cover object-center filter invert-1 filter brightness-2 drop-shadow-md select-none",
      src: "https://www.freepnglogos.com/uploads/destiny-logo-png/best-photos-bungie-destiny-logo-transparent-20.png",
      alt: "",
      loading: "lazy",
    },
  });
...
const stickyHeader = () =>
  craft("top-sticky-header", {
    props: {
      class: "absolute top-0 flex flex-center shadow-lg morph slide-in-down duration-300 delay-5",
    },
    html: `
